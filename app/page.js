...
function CustomerForm({ compact = false }) {
  ...
  return (
    <form
      ...
      onSubmit={submit}
      autoComplete="off"
      className={`grid ${compact ? '' : 'md:grid-cols-2'} gap-3`}
    >
      ...
      <input type="email" name="email" required placeholder="Email" autoComplete="off"
        className="bg-white/10 border border-white/15 rounded px-3 py-2" />
      <input name="phone" placeholder="Phone (for launch SMS)" autoComplete="off"
        className={`${compact ? '' : 'md:col-span-2'} bg-white/10 border border-white/15 rounded px-3 py-2`} />
      <input name="city" placeholder="City" autoComplete="off"
        className="bg-white/10 border border-white/15 rounded px-3 py-2" />
      <input name="zip" placeholder="ZIP code" autoComplete="off"
        className="bg-white/10 border border-white/15 rounded px-3 py-2" />
      <textarea name="notes" placeholder="What kind of clean do you need most?"
        className={`${compact ? '' : 'md:col-span-2'} bg-white/10 border border-white/15 rounded px-3 py-2 h-28`} />
    ...
    <section id="how" className="mx-auto max-w-6xl px-4 py-12">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {[
          ...
          <div key={t} className="bg-white/5 border border-white/10 rounded-xl p-5">
